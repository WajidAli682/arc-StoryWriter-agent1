...
# In-memory storage (Vercel serverless mein yeh temporary hai)
user_sessions = {}

print(f"🎭 AI Story Teller Server Started on Vercel!")
...
def text_to_speech(text, filename):
    ...
    try:
        ...
        if response.status_code == 200:
            # Vercel serverless mein file save nahi kar sakte, isliye base64 return karenge
            import base64
...
def connect():
    ...
    if user_wallet and w3.is_address(user_wallet):
        # Session store karein (Vercel serverless mein temporary)
...
def confirm_tx():
    ...
    # Session se full story get karein
